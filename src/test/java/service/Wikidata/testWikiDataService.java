...
public class testWikiDataService {
    ...
    public void testgetWikiData_Success() {
        ...
        // Then
        assertThat(RestTempUtil.decodeString(wikiInfoObj.getWikipediaSearchTerm())).isEqualTo(succescriteria);
        assertThat(wikiInfoObj.getWikiDataStatuccode()).isEqualTo(200);
    }

    @Test
    public void testExtractData_Success() {
        // Given
        String nirvanaTerm = "Q11649";
        String responseBody = getResponseWithResult();
    ...
    @Test
    public void testExtractDataNoResult() {
        // Given
        String nirvanaTerm = "QTEST";
